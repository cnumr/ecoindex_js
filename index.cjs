const reference = require('ecoindex_reference');

/**
 * Return grades list.
 */
const getEcoIndexGradesList = () => {
...
module.exports.getEcoIndexGradesList = getEcoIndexGradesList;
module.exports.getQuantiles = getQuantiles;
module.exports.computeEcoIndex = computeEcoIndex;
module.exports.computeQuantile = computeQuantile;
module.exports.getEcoIndexGrade = getEcoIndexGrade;
module.exports.computeGreenhouseGasesEmissionfromEcoIndex = computeGreenhouseGasesEmissionfromEcoIndex;
module.exports.computeWaterConsumptionfromEcoIndex = computeWaterConsumptionfromEcoIndex;